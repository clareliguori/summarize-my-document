...
# Deploy the Streamlit-based frontend application in load-balanced Fargate containers
class FrontendStack(Stack):
    def __init__(
        ...
        domain_name = f"summarize-my-document-demo.{parent_domain}"
        ...
        cognito_domain_prefix = "summarize-my-document-demo"
