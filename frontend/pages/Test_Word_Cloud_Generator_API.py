...
word_cloud_generator_api_endpoint = f"{os.getenv('BACKEND_URL')}/word-cloud-generator"
...
auth = AWSRequestsAuth(
    ...
    aws_host=urllib.parse.urlparse(word_cloud_generator_api_endpoint).netloc,
...
with st.form("test_word_cloud_generator_api"):
    ...
    if submitted:
        r = requests.post(
            url=word_cloud_generator_api_endpoint,
            auth=auth,
